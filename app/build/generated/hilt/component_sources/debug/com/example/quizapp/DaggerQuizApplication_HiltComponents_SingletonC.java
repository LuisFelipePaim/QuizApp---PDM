...
import com.example.quizapp.di.AppModule_ProvideAppDatabaseFactory;
import com.example.quizapp.di.AppModule_ProvideFirebaseAuthFactory;
import com.example.quizapp.di.AppModule_ProvideFirestoreFactory;
import com.example.quizapp.di.AppModule_ProvideQuestionDaoFactory;
import com.example.quizapp.di.AppModule_ProvideQuizResultDaoFactory;
import com.example.quizapp.ui.auth.AuthViewModel;
import com.example.quizapp.ui.auth.AuthViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.quizapp.ui.auth.SignUpViewModel;
import com.example.quizapp.ui.auth.SignUpViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerQuizApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends QuizApplication_HiltComponents.ViewModelC {
    ...
    private QuizRepository quizRepository() {
      return new QuizRepository(singletonCImpl.provideFirestoreProvider.get(), singletonCImpl.questionDao(), singletonCImpl.quizResultDao());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.quizapp.ui.auth.AuthViewModel 
          return (T) new AuthViewModel(viewModelCImpl.authRepository());

          case 1: // com.example.quizapp.ui.history.HistoryViewModel 
          return (T) new HistoryViewModel(viewModelCImpl.quizRepository(), viewModelCImpl.authRepository());
  ...
  private static final class SingletonCImpl extends QuizApplication_HiltComponents.SingletonC {
    ...
    private QuestionDao questionDao() {
      return AppModule_ProvideQuestionDaoFactory.provideQuestionDao(provideAppDatabaseProvider.get());
    }

    private QuizResultDao quizResultDao() {
      return AppModule_ProvideQuizResultDaoFactory.provideQuizResultDao(provideAppDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.example.quizapp.data.local.AppDatabase 
